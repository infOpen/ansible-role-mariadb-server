...
describe 'MariaDB 5.5 config', :if => ENV['MARIADB_VERSION'] == '5.5' do
    ...
    context mysql_config('innodb-buffer-pool-restore-at-startup') do
        its(:value) { should eq 0 }
    end
    context mysql_config('innodb-buffer-pool-shm-checksum') do
        its(:value) { should eq 'TRUE' }
    end
    context mysql_config('innodb-buffer-pool-shm-key') do
        its(:value) { should eq 0 }
    end
    ...
    context mysql_config('innodb-checkpoint-age-target') do
        its(:value) { should eq 0 }
    end
    context mysql_config('innodb-checksums') do
        its(:value) { should eq 'TRUE' }
    end
    ...
    context mysql_config('innodb-dict-size-limit') do
        its(:value) { should eq 0 }
    end
    ...
    context mysql_config('innodb-fast-checksum') do
        its(:value) { should eq 'FALSE' }
    end
    # Startup error
    ...
    context mysql_config('innodb-ibuf-accel-rate') do
        its(:value) { should eq 100 }
    end
    context mysql_config('innodb-ibuf-active-contract') do
        its(:value) { should eq 1 }
    end
    context mysql_config('innodb-ibuf-max-size') do
        its(:value) { should eq 67108864 }
    end
    context mysql_config('innodb-import-table-from-xtrabackup') do
        its(:value) { should eq 0 }
    end
    # Startup error
    ...
    context mysql_config('innodb-lazy-drop-table') do
        its(:value) { should eq 0 }
    end
    ...
    context mysql_config('innodb-merge-sort-block-size') do
    ...
    context mysql_config('innodb-recovery-stats') do
        its(:value) { should eq 'FALSE' }
    end
    context mysql_config('innodb-recovery-update-relay-log') do
        its(:value) { should eq 'FALSE' }
    end
    ...
    context mysql_config('innodb-stats-sample-pages') do
        its(:value) { should eq 8 }
    end
    context mysql_config('innodb-stats-traditional') do
        its(:value) { should eq 'TRUE' }
    end
    context mysql_config('innodb-stats-update-need-lock') do
        its(:value) { should eq 1 }
    end
    ...
    context mysql_config('innodb-thread-concurrency-timer-based') do
        its(:value) { should eq 'FALSE' }
    end
    ...
    context mysql_config('innodb-use-sys-stats-table') do
        its(:value) { should eq 'FALSE' }
    end
